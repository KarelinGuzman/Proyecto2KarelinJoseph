...
public class TablaHash {
    ...
    public ArchivoResumen buscarPorTitulo(String titulo){
        ...
        if(this.archivosResumen[hash].pFirst.dato.titulo.equals(titulo)){
            return this.archivosResumen[hash].pFirst.dato;
        }else{
            return this.archivosResumen[hash].buscar(titulo);
        }
    }
